...
SOL = pygame.image.load(os.path.join(IMG_DIR, 'Other/Sun.png'))
SOL = pygame.transform.scale(SOL, (int(SOL.get_width() / 5), int(SOL.get_height() / 5)))
IMG_DIR = os.path.join(os.path.dirname(__file__), "..", "assets")
ruta_musica = os.path.join(IMG_DIR, "Dino/Jala.mp3")
